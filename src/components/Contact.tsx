    ...
    <section id="contact" className="py-24 bg-snow-white text-slate-gray">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-display font-bold text-mountain-blue mb-4 tracking-tight">{t.contact.title}</h2>
          ...
          >
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-mountain-blue mb-1">{t.contact.labels.location}</h4>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-mountain-blue mb-1">{t.contact.labels.phone}</h4>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-mountain-blue mb-1">{t.contact.labels.email}</h4>
            ...
            <div className="flex space-x-4 pt-4">
              ...
              >
                <Phone size={20} />
                <span className="font-medium">{t.contact.quickActions.call}</span>
              </a>
              <a
              ...
              >
                ...
                <span className="font-medium">{t.contact.quickActions.whatsapp}</span>
              </a>
            </div>
            ...
            <div className="w-full h-64 rounded-2xl overflow-hidden shadow-inner border border-gray-200">
              <iframe
                ...
                src="https://www.google.com/maps?q=Janovi%C4%8Dky%20u%20Broumova&output=embed"
